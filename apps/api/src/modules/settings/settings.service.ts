...
const DEFAULTS: Omit<Setting, 'id' | 'updatedAt'>[] = [
  ...
  { key: 'reminder_channels',   value: 'email,whatsapp', label: 'Canales de recordatorio', group: 'notifications' },
  { key: 'whatsapp_enabled',              value: 'true', label: 'WhatsApp activo', group: 'whatsapp' },
  { key: 'whatsapp_auto_on_create',         value: 'true', label: 'Mensaje al crear turno', group: 'whatsapp' },
  { key: 'whatsapp_reminder_48h',           value: 'true', label: 'Recordatorio WA 48h', group: 'whatsapp' },
  { key: 'whatsapp_reminder_24h',           value: 'true', label: 'Recordatorio WA 24h', group: 'whatsapp' },
  { key: 'whatsapp_reminder_2h',            value: 'true', label: 'Recordatorio WA 2h', group: 'whatsapp' },
  { key: 'whatsapp_content_appointment_sid', value: '', label: 'Content SID turno (Twilio)', group: 'whatsapp' },
  { key: 'whatsapp_content_reminder_sid',    value: '', label: 'Content SID recordatorio (Twilio)', group: 'whatsapp' },
